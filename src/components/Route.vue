...
<template>
  ...
  >
    <div class="d-flex align-items-center pb-3 mb-3 link-dark border-bottom">
      ...
      <a href="#" class="text-decoration-none ms-auto black" @click="addDay">
        <svg
    ...
    <ul class="list-unstyled ps-0" :key="day.id" v-for="(day, index) in days">
      <li class="mb-1">
        ...
        <a
          href="#"
          class="text-decoration-none float-end black"
          ...
          >
            <li>
              <div style="margin-bottom: 0.3em">
                ...
                <span class="metric" style="margin-left: 0.6em">
                  {{ day.distance }} km</span
                >
                <svg
                  class="metric-icon"
                  width="24px"
