...
<template>
  ...
  >
    ...
    >
      ...
      <div
        id="routeListTotals"
        style="margin-left: 0.3em; margin-right: 1.5em; cursor: move"
      >
        <svg
          class="metric-icon"
          width="24px"
              ...
              <li>
                <div class="form-check form-switch">
                  <input
                    ...
                    type="checkbox"
                    v-bind:id="toStr('flexSwitchCheckChecked', element.id)"
                    v-model="element.showOnMap"
                    @change="onShowRouteOnMap(element)"
                    checked
                  />
                  <label
                    class="form-check-label"
                    v-bind:for="toStr('flexSwitchCheckChecked', element.id)"
                    >Show on map</label
                  >
                </div>
                ...
                <div class="input-group input-group-sm mb-3 custom-file-button">
                  ...
                  <input
                    ...
                    accept=".gpx"
                    v-on:change="selectedGPXFile($event, element)"
                  />
                  <span
                    class="day-title"
                ...
                <apexchart
                  ...
                  :series="element.elevationPoints"
                ></apexchart>
              </li>
            </ul>
          </div>
